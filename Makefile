...
staging::
	...
	curl -L -X PUT "http://svc.deploy.coffee:8080/v2/apps/click-count?force=true" -H "Content-type: application/json" -u "horgix:verysecure" -d @marathon_app_staging.json 
